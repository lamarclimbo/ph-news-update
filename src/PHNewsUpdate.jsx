...
/**
 * PH News Update — Single‑Page React Site
 * --------------------------------------------------------
 * ✅ Mobile‑first, fast, and accessible
 * ✅ Category tabs + live trending ticker
 * ✅ Search + share‑ready article cards
 * ✅ Dark mode toggle (persisted in localStorage)
 * ✅ SEO microdata, OpenGraph, and JSON‑LD (in page)
 * ✅ Minimal, modern Tailwind design (no external UI kit required)
 *
 * HOW TO USE
 * 1) Drop this component into a React/Vite/Next project with Tailwind.
 * 2) Set your brand in BRAND constant below.
 * 3) Replace SAMPLE_ARTICLES with real content or wire up your CMS/RSS.
 * 4) (Optional) Hook the fetcher in useEffect to your API endpoint.
 */
...
const BRAND = {
  ...
  domain: "https://phnews.update.example",
  logoText: "PH",
  primaryCategories: ["Top", "Nation", "Metro", "Business", "World", "Sports", "Tech", "Showbiz"],
};
...
export default function PHNewsUpdate() {
  ...
  // Example: Plug your API here
  useEffect(() => {
    // setLoading(true);
    // fetch("/api/articles").then(r => r.json()).then(data => setArticles(data)).finally(()=> setLoading(false));
  }, []);
        ...
        <section className="mt-14">
          <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 p-6 bg-gradient-to-br from-sky-50 to-white dark:from-neutral-900 dark:to-neutral-950">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <form
                onSubmit={(e) => { e.preventDefault(); alert("Subscribed! Replace with your email service."); }}
